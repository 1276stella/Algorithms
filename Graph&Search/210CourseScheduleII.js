...
var findOrder = function(numCourses, prerequisites) {
  ...
  return hasCycle ? [] : resultStack.reverse();
};

var prerequisites = [[1,0],[2,1],[3,2],[1,3],[3,4]];
console.log(findOrder(5, prerequisites)); // false

prerequisites = [[1,0],[2,1],[3,2],[3,4]];
console.log(findOrder(5, prerequisites)); // [ 4, 0, 1, 2, 3 ]